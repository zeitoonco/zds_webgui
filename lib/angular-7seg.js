...
(function (window, angular) {
    ...
    var app = angular.module('wo.7segments', []) /*jshint ignore:line*/
        ...
        .run(["$document", function ($document) {
            ...
            style.innerHTML = '.seven-seg-digit{ fill: #DEDEDE; overflow: hidden;' +
                'stroke-width: 0; height: 100%; width: 100%; background-color: White;}' +
                '.seven-seg-on{fill:#474747;}' +
    ...
    /*global angular*/
    angular.module("wo.7segments").run(["$templateCache", function ($templateCache) {
        $templateCache.put("digit.html", "<svg data-ng-class=\"opt.digitClass\" viewBox=\"0 0 57 80\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" focusable=\"false\"> <g> <polyline data-ng-repeat=\"point in ::points\" ng-attr-points=\"{{point}}\" data-ng-class=\"(segVal | bitAndWithBitwise : $index) && opt.onClass\"></polyline> <circle cx=\"52\" cy=\"75\" r=\"5\" data-ng-class=\"(segVal | bitAnd : 128) && opt.onClass\"></circle> </g> </svg>");
        $templateCache.put("group.html", "<div style='direction: ltr;' data-ng-repeat=\"dig in digits track by $index\" seg-digit data-ng-model=\"dig\" seg-digit-options=\"segDigitOptions\"> </div>");
    }]);
